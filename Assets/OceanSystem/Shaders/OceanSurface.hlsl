...
// URP 17's DeclareDepthTexture.hlsl now declares _CameraDepthTexture_TexelSize
// itself. The package's manual declaration was a URP 10-era workaround; on URP 17
// it causes "redefinition" errors, so we drop it.
