    ...
    public class CompactTextureDrawer : MaterialPropertyDrawer
    {
        ...
        public override float GetPropertyHeight(MaterialProperty prop, string label, MaterialEditor editor)
        {
            ...
            if (mode == CompactTextureMode.Default &&
                !prop.propertyFlags.HasFlag(UnityEngine.Rendering.ShaderPropertyFlags.NoScaleOffset))
            ...
            MaterialEditor editor, CompactTextureMode mode)
        {
            ...
            if (prop.propertyFlags.HasFlag(UnityEngine.Rendering.ShaderPropertyFlags.NoScaleOffset))
                return;
