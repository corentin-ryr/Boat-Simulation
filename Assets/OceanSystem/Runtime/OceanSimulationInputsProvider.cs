...
namespace OceanSystem
{
    ...
    public class OceanSimulationInputsProvider : ScriptableObject
    {
        ...
        {
            // Upstream bug: the original code immediately wrote
            //   windForce01 = _displayWindForce01;
            // which discarded the caller's parameter and forced every runtime
            // request to use the asset's editor-preview value. That made
            // OceanSimulation._windForce01 a dead field. Removed so the caller
            // actually drives the wind force.
